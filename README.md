...
1. What does overall sales performance look like — trend, seasonality, top categories, top regions?
2. **Does late delivery actually hurt customer satisfaction, and is it statistically significant?**
3. Which customers are most valuable, and which are worth a retention push?

## Dataset

This project uses a **synthetic dataset** generated by `src/generate_data.py`,
structured to match the real [Olist Brazilian E-Commerce dataset](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce)
